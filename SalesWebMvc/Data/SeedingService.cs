...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            {
                return; //caso já exista dados no bd, interrompe a ação
            }
            ...
            _context.Department.AddRange(d1, d2, d3, d4); // Adicionando os objetos no banco de dados através do entity framework
            ...
            _context.SaveChanges(); //efetivando as alterações no banco de dados
        }
    }
}
